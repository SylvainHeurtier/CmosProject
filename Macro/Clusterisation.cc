	...
	switch(length){
		...
		case 3:
			if(List[1]==List[0]+npxl_row && List[2]==List[0]+npxl_row+1)
				return 3;
			if(List[1]==List[0]+npxl_row -1 && List[2]==List[0]+npxl_row)
				return 4;
			if(List[2]==List[0]+npxl_row*2)
				return 5;
			if(List[1]==List[0]+1 && List[2]==List[0]+npxl_row)
				return 6;
			...
			if(List[2]==List[0]+2)
				return 8;
		case 4:
			if(List[1]==List[0]+npxl_row-1 && List[2]==List[0]+npxl_row && List[3]==List[0]+npxl_row+1)
				return 9;
			if(List[1]==List[0]+npxl_row && List[2]==List[0]+npxl_row+1 && List[3]==List[0]+npxl_row*2)
				return 10;
			if(List[1]==List[0]+npxl_row && List[2]==List[0]+npxl_row*2 && List[3]==List[0]+npxl_row*2+1)
				return 11;
			if(List[1]==List[0]+1 && List[2]==List[0]+npxl_row && List[3]==List[0]+npxl_row+1)
				return 12;
			if(List[1]==List[0]+1 && List[2]==List[0]+npxl_row+1 && List[3]==List[0]+npxl_row+2)
				return 13;
			if(List[1]==List[0]+npxl_row && List[2]==List[0]+npxl_row+1 && List[3]==List[0]+npxl_row+2)
				return 14;
			if(List[1]==List[0]+npxl_row && List[2]==List[0]+npxl_row+1 && List[3]==List[0]+npxl_row*2+1)
				return 15;
			if(List[1]==List[0]+npxl_row-1 && List[2]==List[0]+npxl_row && List[3]==List[0]+2*npxl_row)
				return 16;
			if(List[1]==List[0]+npxl_row && List[2]==List[0]+npxl_row*2-1 && List[3]==List[0]+npxl_row*2)
				return 17;
			if(List[1]==List[0]+1 && List[2]==List[0]+npxl_row-1 && List[3]==List[0]+npxl_row)
				return 18;
			if(List[1]==List[0]+npxl_row-2 && List[2]==List[0]+npxl_row-1 && List[3]==List[0]+npxl_row)
				return 19;
			if(List[1]==List[0]+npxl_row-1 && List[2]==List[0]+npxl_row && List[3]==List[0]+npxl_row*2-1)
				return 20;
			if(List[3]==List[0]+npxl_row*3)
				return 21;
			if(List[1]==List[0]+1 && List[2]==List[0]+npxl_row && List[3]==List[0]+npxl_row*2)
				return 22;
			if(List[1]==List[0]+1 && List[2]==List[0]+npxl_row+1 && List[3]==List[0]+npxl_row*2+1)
				return 23;
			if(List[1]==List[0]+1 && List[2]==List[0]+2 && List[3]==List[0]+npxl_row+1)
				return 24;
			if(List[1]==List[0]+1 && List[2]==List[0]+2 && List[3]==List[0]+npxl_row)
				return 25;
			if(List[1]==List[0]+1 && List[2]==List[0]+2 && List[3]==List[0]+npxl_row+2)
				return 26;
			if(List[3]==List[0]+3)
				return 27;
	}
...
void Clusterisation()
{
	...
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_0deg_100Evt_10000part_radius600um.root"));
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_10deg_100Evt_10000part_radius600um.root"));
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_20deg_100Evt_10000part_radius600um.root"));
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_30deg_100Evt_10000part_radius600um.root"));
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_40deg_100Evt_10000part_radius600um.root"));
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_50deg_100Evt_10000part_radius600um.root"));
	filenames->Add((TObject*) new TString("/home/sh275430/bin/CmosProject/build/ED_60deg_100Evt_10000part_radius600um.root"));
    ...
    c1->Modified();
    gPad->BuildLegend(0.8,0.6,0.4,0.9);
	gPad->SetLogy(kTRUE);
